        ...
        <section className="py-32 bg-brand-bg-soft">
            ...
            <div className="max-w-[1200px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-12">
                {PILLARS.map((pillar, index) => (
                    ...
                    >
                        <div className="w-16 h-16 rounded-agency-md bg-white shadow-sm flex items-center justify-center text-brand-primary group-hover:bg-brand-primary group-hover:text-white transition-colors duration-300">
                            <pillar.icon size={28} />
                        </div>
