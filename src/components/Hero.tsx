...
export default function Hero() {
    return (
        <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-beige via-white to-beige/50 -z-10" />
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative flex items-center justify-center">
                        <div className="relative w-full max-w-lg">
                            <div className="absolute inset-0 bg-gradient-to-br from-primary to-accent rounded-3xl transform rotate-6 opacity-20 blur-xl" />
                            ...
                            <div className="relative bg-white p-8 rounded-3xl shadow-2xl border border-gray-200">
                                <div className="space-y-6">
                                    ...
                                    <div className="text-center space-y-2">
                                        ...
                                        <p className="text-gray-700">Technologies modernes & IA</p>
                                    </div>
